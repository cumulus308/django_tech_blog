...
gantt
    ...
    댓글 기능 구현                    :2023-08-31, 2d
    정적 파일 모으기 (collectstatic)  :2023-09-01, 1d
    번역 기능 (en, kr) 추가           :2023-09-01, 1d
    AWS Lightsail로 배포 (선택사항)    :2023-09-01, 1d
    AI 기능 추가 (선택사항)           :2023-09-01, 1d

    section 테스트 및 피드백
    기능 테스트                       :2023-08-30, 2d
    사용자 테스트                     :2023-08-31, 2d
